...
namespace Assignment1
{
    public class DirWalker
    {
        ...
        public static void Main(string[] args)
        {
            ...
            string rootDirectory = @"C:\Users\srira\source\repos\dotNET Assignment 1\dotNET Assignment 1\Sample Data\";
            string outputFilePath = @"C:\Users\srira\source\repos\dotNET Assignment 1\dotNET Assignment 1\Output\Output.csv";  
            string logFilePath = @"C:\Users\srira\source\repos\dotNET Assignment 1\dotNET Assignment 1\Log\Log.txt"; 
